...
import ServicesCards from "../../utility/ServicesCards";
...
const Service = () => {
  ...
  return (
    <div
      className="my-12 mx-12 flex flex-col justify-center items-center"
      id="services"
    >
      ...
      <div className="text-[16px] px-12">
        TechnoCom delivers trusted excellent quality services using New &
        Enhance development technologies. Customer oriented to the full. From
        big projects to small ones from complex sophisticated solutions to more
        simple tools. We evaluate the strategies, throwing light on the
        Effectiveness and efficiency of the plans in Achieving results. Because
        it’s of the utmost importance to examine the overall well-being of the
        company and the goals it follows. We never stay in the same place.
        Constant and perpetual improving drives our company from the very
        beginning. We try to get better and better every single day. It`s our
        way to excellence!
      </div>
